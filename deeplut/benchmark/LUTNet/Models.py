...
class CNV(nn.Module):
    def __init__(self, k, mask_builder, device):
        ...
        self.layers = nn.Sequential(
            ...
            nn.BatchNorm2d(256),
            ResidualSign(),
            DConv2d(256, 256, 3, LagrangeTrainer, mask_builder, bias=False,
                    k=k, input_expanded=False, input_dim=3, device=device),
            nn.BatchNorm2d(256),
            ResidualSign(),
...
class LFC(nn.Module):
    def __init__(self, k, mask_builder, device):
        ...
        self.layers = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            ResidualSign(),
            DLinear(256, 256, k, 0, False, LagrangeTrainer,
                    mask_builder, False, device),
            nn.BatchNorm1d(256),
            ResidualSign(),
            DLinear(256, 256, k, 0, False, LagrangeTrainer,
                    mask_builder, False, device),
            ...
            nn.BatchNorm1d(256),
            ResidualSign(),
            DLinear(256, 10, k, 0, False, LagrangeTrainer,
                    mask_builder, False, device),
            nn.BatchNorm1d(10),
        )
