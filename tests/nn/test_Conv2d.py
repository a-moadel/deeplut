...
class test_Conv2d(unittest.TestCase):
    ...
    def test_conv2d_forward(self):
        ...
        conv2d = Conv2d(in_channels=3, out_channels=2, kernel_size=3, stride=(
            1, 1), padding=0, dilation=1, groups=1, bias=True, input_dim=5, trainer_type=LagrangeTrainer)
    ...
    def test_conv2d_forward(self):
        ...
        conv2d = Conv2d(in_channels=3, out_channels=2, kernel_size=3, stride=(
            2, 2), padding=0, dilation=1, groups=1, bias=True, input_dim=10, trainer_type=LagrangeTrainer)
